...
import { DIAMOND_ADDRESS } from "../../../../lib/contracts/contracts";
...
const App = () => {
  ...
  useEffect(() => {
    if (item) {
      const checkOwner = async () => {
        ...
        if (owner.toLocaleLowerCase() === DIAMOND_ADDRESS.toLocaleLowerCase()) {
          owner = "Nobody";
        }
  ...
  useEffect(() => {
    if (
      ...
      id &&
      ownr &&
      ownr.toLocaleLowerCase() !== DIAMOND_ADDRESS.toLowerCase()
    ) {
